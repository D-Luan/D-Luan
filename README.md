...
I'm a backend developer focused on C#, .NET, relational databases, automated testing, and cloud-based applications. I build practical projects to improve my skills in REST APIs, software architecture, SQL, Docker, CI/CD, and Microsoft Azure.
